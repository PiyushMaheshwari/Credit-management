...
<html>
    ...
    <div class="w3-card-4 w3-mobile" style="width:50%;margin-left:25%;margin-top:-2%">
        
        <header class="w3-container w3-teal"><br/>
            <h2 class="w3-text-white w3-center w3-mobile"> <b><i>ADD USER </b></i> </h2>
            <div><br/>
            <a href="index.php"><button class="w3-button w3-right w3-mobile" style="margin-top: -12%">&#10094;</button></a>
            </div>
        </header>
        <form name="newuser" method="post" style="margin-left:10%;margin-right:10%" onsubmit="mysuccess()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" ><br/>
            <label> Name : </label><br/>
